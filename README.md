...
This project simulates a real-world event-driven (small) backend system where multiple services emit inconsistent events that must be ingested, normalized, processed, and stored reliably. (Yes, this spec was written by ChatGPT)
